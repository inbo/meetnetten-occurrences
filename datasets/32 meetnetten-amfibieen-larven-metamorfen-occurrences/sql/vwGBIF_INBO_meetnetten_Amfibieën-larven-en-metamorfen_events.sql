...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 13/09/2019 14:21:54 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën-larven-en-metamorfen_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - Amfibieën - larven en metamorfen, Belgium'
...
--	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STCentroid().STX) as decimalLongitude
	...
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STStartPoint().STX) as decimalLongitudeSart
...
AND fa.ProtocolID =  '32'
--AND VisitStartDate IS NULL
AND fa.SpeciesLifestageKey = '1'
