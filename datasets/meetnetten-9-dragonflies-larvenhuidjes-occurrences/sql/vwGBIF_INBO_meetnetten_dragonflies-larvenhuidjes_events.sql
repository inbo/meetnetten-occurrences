...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_dragonflies-larvenhuidjes_events]    Script Date: 9/09/2019 15:25:44 ******/
SET ANSI_NULLS ON
GO
...
/* generieke query events, test met vuursalamander
   ...
   GEOM geeft geen coördiaten terug op dit moment 2019-09-09  --> startpunt van het transect (of eindpunt?)
 */

/**ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_dragonflies-larvenhuidjes_events]
AS**/
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - dragonflies-larvenhuidjes, Belgium'
...
--	, CONVERT(decimal(10,5), dL.LocationGeom.STCentroid().STY) as decimalLatitude1
--	, CONVERT(decimal(10,5), dL.LocationGeom.STCentroid().STX) as decimalLongitude1
...
--	, [waterbody] = dL.Location
	...
	, [georeferenceRemarks] = N'coordinates are the startpoint of the transect' 
	...
	, CONVERT(decimal(10,5), dL.LocationGeom.STLength()) as lengthe
