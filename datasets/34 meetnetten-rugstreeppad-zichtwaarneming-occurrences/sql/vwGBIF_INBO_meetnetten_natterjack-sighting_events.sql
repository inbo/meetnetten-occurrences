...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 13/09/2019 15:02:50 ******/
SET ANSI_NULLS ON
GO
...
/**CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_natterjack-sighting_events]
AS**/
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - Natterjack - sighting, Belgium'
...
AND fa.ProtocolID =  '34'
AND dSl.SpeciesLifestageID = '1'
