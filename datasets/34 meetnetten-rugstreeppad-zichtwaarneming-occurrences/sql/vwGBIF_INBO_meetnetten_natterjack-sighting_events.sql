...
/****** Object:  View [ipt].[vwGBIF_INBO_meetnetten_34_rugstreeppad_sighting_events]    Script Date: 30/10/2020 9:35:07 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [ipt].[vwGBIF_INBO_meetnetten_34_rugstreeppad_sighting_events]
AS
...
--	  [occurrenceID] = N'INBO:MEETNETTEN:OCC:' + Right( N'0000' + CONVERT(nvarchar(20) ,fa.FieldworkObservationID),7)
	...
	, [datasetID] = N'https://doi.org/10.15468/2xfw8y'
	, [datasetName] = N'Meetnetten.be - Sightings for Natterjack toad in Flanders, Belgium'
...
--	, [basisOfRecord] = N'HumanObservation'
	, [samplingProtocol] =  CASE Protocolname
							...
							WHEN 'Vuursalamander - Transect (v1)' THEN 'fire salamander transect'
							WHEN 'Rugstreeppad - Zichtwaarneming' THEN 'natterjack toad sighting'
							ELSE ProtocolName
							END
--	, fa.ProtocolID
...
AND fa.ProtocolID IN ('34')  ---rugstreeppad zichtwaarneming * 
--AND Aantal > '0'
