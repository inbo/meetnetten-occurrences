...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 13/09/2019 11:30:35 ******/
SET ANSI_NULLS ON
GO
...
/**ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën-Larven_events]
AS**/
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - Amfibieën - Larven, Belgium'
...
--	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STCentroid().STX) as decimalLongitude
	...
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STEndPoint().STY) as decimalLatitudeStop
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STEndPoint().STX) as decimalLongitudeStop
