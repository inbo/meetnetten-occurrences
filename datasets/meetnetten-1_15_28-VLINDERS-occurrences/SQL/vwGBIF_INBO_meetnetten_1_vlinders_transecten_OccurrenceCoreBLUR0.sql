...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_1_15_19_28_vlinders_transecten_OccurrenceCore_BLUR0]    Script Date: 30/09/2019 14:24:39 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_1_15_19_28_vlinders_transecten_OccurrenceCore_BLUR0]
AS
...
--	, [waterbody] = dL.Location
	...
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STCentroid().STY) as decimalLatitudeCentroid
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STCentroid().STX) as decimalLongitudeCentroid
	
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STStartPoint().STY) as decimalLatitudeString
	, CONVERT(decimal(10,5), dL.LocationGeom.MakeValid().STStartPoint().STX) as decimalLongitudeString
...
AND Dbl.BlurDistance = '0'
--and (SUBSTRING (dL.LocationGeom.MakeValid().STAsText(),0,CHARINDEX('(',(dL.LocationGeom.MakeValid().STAsText())))) in ('MULTILINESTRING','LINESTRING')
