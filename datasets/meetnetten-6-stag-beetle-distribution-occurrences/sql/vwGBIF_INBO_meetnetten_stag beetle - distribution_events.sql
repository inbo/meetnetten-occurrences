...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_stag beetle - distribution_events]    Script Date: 3/09/2019 15:04:38 ******/
SET ANSI_NULLS ON
GO
...
SELECT * FROM [iptdev].[vwGBIF_INBO_meetnetten_stag beetle - distribution_events];
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_stag beetle - distribution_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - stag beetle - distribution, Belgium'
