...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_dragonflies population count per location_occurrence]    Script Date: 3/09/2019 15:30:15 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_dragonflies population count per location_occurrence]
AS
