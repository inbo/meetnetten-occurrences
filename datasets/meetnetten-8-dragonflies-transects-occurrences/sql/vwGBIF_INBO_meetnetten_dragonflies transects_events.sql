...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 9/09/2019 13:59:13 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_dragonflies transects_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - dragonflies transects, Belgium'
...
FROM (SELECT DISTINCT(FieldworkSampleID),FieldworkVisitID,ProjectKey, 
					  ...
					  FROM dbo.FactAantal WHERE FieldworkSampleID > 0) fA
