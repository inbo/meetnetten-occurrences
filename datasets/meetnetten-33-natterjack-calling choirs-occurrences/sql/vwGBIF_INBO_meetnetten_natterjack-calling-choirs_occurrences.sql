...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_occurrences]    Script Date: 13/09/2019 14:44:08 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_natterjack-calling-choirs_occurrences]
AS
...
/**      [type] = N'Event'
	...
	, [datasetName] = N'Meetnetten - Natterjack - calling choirs, Belgium'
