...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_gerande-oeverspin-inhaalslag_events]    Script Date: 13/09/2019 13:39:43 ******/
SET ANSI_NULLS ON
GO
...
/* generieke query events, test met vuursalamander
   ...
   speciesLifestageID = '1'   CHECK for eventID doubles
 */

ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_gerande-oeverspin-inhaalslag_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - Gerande oeverspin - inhaalslag, Belgium'
...
AND fa.ProtocolID =  '27'
AND fa.SpeciesLifestageID = '1'
