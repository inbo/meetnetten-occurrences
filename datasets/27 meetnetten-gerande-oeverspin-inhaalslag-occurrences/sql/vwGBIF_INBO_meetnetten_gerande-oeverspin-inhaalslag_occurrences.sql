...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_occurrences]    Script Date: 13/09/2019 13:46:24 ******/
SET ANSI_NULLS ON
GO
...
/* Generieke query inclusief soorten 
	...
	add 'sex'
	This is not ok for the moment
*/



ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_gerande-oeverspin-inhaalslag_occurrences]
AS
