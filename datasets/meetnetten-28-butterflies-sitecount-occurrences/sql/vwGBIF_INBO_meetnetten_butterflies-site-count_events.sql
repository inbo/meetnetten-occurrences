...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 13/09/2019 13:55:51 ******/
SET ANSI_NULLS ON
GO
...
/* generieke query events, test met vuursalamander
   ...
   2019-09-13  AND fa.SpeciesLifestageID = '1'
 */

ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_butterflies-site-count_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - butterflies - site count, Belgium'
