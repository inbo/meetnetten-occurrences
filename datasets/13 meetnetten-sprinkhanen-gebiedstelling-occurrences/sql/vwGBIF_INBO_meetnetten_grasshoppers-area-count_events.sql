...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_generiek_events]    Script Date: 12/09/2019 11:29:56 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_grasshoppers-area-count_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - grasshoppers area count, Belgium'
