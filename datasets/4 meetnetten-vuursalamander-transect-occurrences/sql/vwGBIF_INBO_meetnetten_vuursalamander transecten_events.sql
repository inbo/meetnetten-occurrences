...
/****** Object:  View [ipt].[vwGBIF_INBO_meetnetten_02_amfibieen_fuiken_events]    Script Date: 30/07/2020 10:36:09 ******/
SET ANSI_NULLS ON
GO
...
--	  [occurrenceID] = N'INBO:MEETNETTEN:OCC:' + Right( N'0000' + CONVERT(nvarchar(20) ,fa.FieldworkObservationID),7)
	...
	, [datasetName] = N'Meetnetten.be - fire salamander transects in Flanders, Belgium'
...
AND fa.ProtocolID IN ('4')  ---fire salamander transects * 
--AND Aantal > '0'
