...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_butterfly transects(algemene monitoring)_occurrence]    Script Date: 3/09/2019 15:28:27 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [iptdev].[vwGBIF_INBO_meetnetten_butterfly transects(algemene monitoring)_occurrence]
AS
