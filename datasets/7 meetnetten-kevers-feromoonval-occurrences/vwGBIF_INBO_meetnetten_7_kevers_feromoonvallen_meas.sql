...
/****** Object:  View [ipt].[vwGBIF_INBO_meetnetten_25_32_amfibieen_larven_en_metamorfen_Meas]    Script Date: 21/08/2020 14:16:30 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [ipt].[vwGBIF_INBO_meetnetten_7_kevers_feromoonval_Meas]
AS
...
AND fa.ProtocolID IN ('7')  ---amfibieën larven meas
--AND Aantal > '0'
