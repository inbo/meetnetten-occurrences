...
/****** Object:  View [ipt].[vwGBIF_INBO_meetnetten_25_32_amfibieen_larven_en_metamorfen_events]    Script Date: 21/08/2020 14:08:24 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [ipt].[vwGBIF_INBO_meetnetten_7_kevers_feromoonval_events]
AS
...
--	  [occurrenceID] = N'INBO:MEETNETTEN:OCC:' + Right( N'0000' + CONVERT(nvarchar(20) ,fa.FieldworkObservationID),7)
	...
	, [datasetName] = N'Meetnetten.be - Coleoptera in pheromone traps in Flanders, Belgium'
...
--	, [basisOfRecord] = N'HumanObservation'
	, [samplingProtocol] =  CASE Protocolname
							...
							WHEN 'Amfibieën - Larven en metamorfen' THEN 'amphibia larvae and metamorphs count'
							WHEN 'Kevers - Feromoonval' THEN 'Coleoptera - pheromone trap'
							ELSE ProtocolName
							END
--	, fa.ProtocolID
...
AND fa.ProtocolID IN ('7')  ---Coleoptera pheromone trap* 
--AND Aantal > '0'
