...
/****** Object:  View [ipt].[vwGBIF_INBO_meetnetten_08_libellen-transect-events]    Script Date: 29/10/2020 10:53:30 ******/
SET ANSI_NULLS ON
GO
...
--	  [occurrenceID] = N'INBO:MEETNETTEN:OCC:' + Right( N'0000' + CONVERT(nvarchar(20) ,fa.FieldworkObservationID),7)
	...
	, [datasetID] = N'https://doi.org/10.15468/y8u6e9'
...
AND fa.ProtocolID IN ('8')  ---Dragonflies transecten * 
--AND Aantal > '0'
